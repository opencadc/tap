...
public class TapSchemaDAOImpl extends TapSchemaDAO {
    ...
    public static Set<GroupURI> getGroupIDs(IvoaGroupClient gmsClient)
            throws AccessControlException, InterruptedException, ResourceNotFoundException {
        try {
            if (CredUtil.checkCredentials()) {
                ...
                log.debug("search " + gmsURI + "found: " + groups.size());
                return groups;
            }
            throw new AccessControlException("cannot check group memberships - no credentials available");
