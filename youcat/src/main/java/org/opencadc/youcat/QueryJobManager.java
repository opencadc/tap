 ...
 * @author pdowler
 */
public class QueryJobManager extends RequestPathJobManager {
    private static final Logger log = Logger.getLogger(QueryJobManager.class);

    private static final Long MAX_EXEC_DURATION = 8 * 3600L;       // 8 hours to dump a catalog to vospace
    ...
    public QueryJobManager() {
        ...
        JobExecutor jobExec = new ThreadPoolExecutor(jobPersist, CatalogQueryRunner.class, 6);
