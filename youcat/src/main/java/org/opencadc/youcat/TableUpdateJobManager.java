 ...
 * @author pdowler
 */
public class TableUpdateJobManager extends RequestPathJobManager {
    private static final Logger log = Logger.getLogger(TableUpdateJobManager.class);

    private static final Long MAX_EXEC_DURATION = 4 * 3600L;       // 4 hours
    private static final Long MAX_DESTRUCTION = 7 * 24 * 60 * 60L; // 1 week
    private static final Long MAX_QUOTE = 24 * 3600L;              // 24 hours: small thread pool
