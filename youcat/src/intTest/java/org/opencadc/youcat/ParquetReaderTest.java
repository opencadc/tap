...
public class ParquetReaderTest extends AbstractTablesTest {
    ...
    private void testParquetReader(boolean withMetadata) throws Exception {
        ...
        compareTableData(voDocFromParquetReader.getResourceByType("results").getTable(), withMetadata);

        // TODO: experimental - Remove if not needed
        // out to RandomAccessSource
    ...
    private void compareTableData(VOTableTable voTableFromParquet, boolean withMetadata) {
