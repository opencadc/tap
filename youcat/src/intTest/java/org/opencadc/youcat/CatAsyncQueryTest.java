 ...
 * @author pdowler
 */
public class CatAsyncQueryTest extends TapAsyncQueryTest
{
    private static final Logger log = Logger.getLogger(CatAsyncQueryTest.class);
    ...
    public CatAsyncQueryTest() 
    { 
        super(Constants.RESOURCE_ID);
        
        // re-use SyncResultTest files
        File testFile = FileUtil.getFileFromResource("AsyncResultTest-ts-columns.properties", CatSyncQueryTest.class);
        if (testFile.exists())
        {
