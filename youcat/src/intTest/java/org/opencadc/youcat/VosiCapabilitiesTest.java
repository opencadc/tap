...
public class VosiCapabilitiesTest extends CapabilitiesTest {
    ...
    protected void validateContent(Capabilities caps) throws Exception {
        ...
        Assert.assertNotNull("cert tables", tables.findInterface(Standards.SECURITY_METHOD_CERT, Standards.INTERFACE_PARAM_HTTP));
        Assert.assertNotNull("cookie tables", tables.findInterface(Standards.SECURITY_METHOD_COOKIE, Standards.INTERFACE_PARAM_HTTP));

        Capability atu = caps.findCapability(Standards.PROTO_TABLE_UPDATE_ASYNC);
        Assert.assertNotNull("table-update-async", atu);
        Assert.assertNotNull("cert table-update-async", atu.findInterface(Standards.SECURITY_METHOD_CERT, Standards.INTERFACE_PARAM_HTTP));
        Assert.assertNotNull("cookie table-update-async", atu.findInterface(Standards.SECURITY_METHOD_COOKIE, Standards.INTERFACE_PARAM_HTTP));
