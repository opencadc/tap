 ...
 * @author pdowler
 */
public class CatSyncQueryTest extends TapSyncQueryTest {

    private static final Logger log = Logger.getLogger(CatSyncQueryTest.class);
    ...
    public CatSyncQueryTest() {
        super(Constants.RESOURCE_ID);

        // re-use SyncResultTest files
        File testFile = FileUtil.getFileFromResource("SyncResultTest-ts-columns.properties", CatSyncQueryTest.class);
        if (testFile.exists()) {
