 ...
 * @author pdowler
 */
public class CatSyncErrorTest extends TapSyncErrorTest
{
    private static final Logger log = Logger.getLogger(CatSyncErrorTest.class);
    ...
    public CatSyncErrorTest() 
    { 
        super(Constants.RESOURCE_ID);
        
        // re-use SyncResultTest files
        File testFile = FileUtil.getFileFromResource("SyncErrorTest-ATTEMPT-DELETE.properties", CatSyncErrorTest.class);
        if (testFile.exists())
        {
