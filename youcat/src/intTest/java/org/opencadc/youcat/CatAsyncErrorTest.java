 ...
 * @author pdowler
 */
public class CatAsyncErrorTest extends TapAsyncErrorTest
{
    private static final Logger log = Logger.getLogger(CatAsyncErrorTest.class);
    ...
    public CatAsyncErrorTest() 
    { 
        super(Constants.RESOURCE_ID);
        
        // re-use SyncResultTest files
        File testFile = FileUtil.getFileFromResource("AsyncErrorTest.foo.properties", CatSyncQueryTest.class);
        if (testFile.exists())
        {
