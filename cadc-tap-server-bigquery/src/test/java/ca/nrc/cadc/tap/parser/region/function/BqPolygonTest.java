...
public class BqPolygonTest {
    ...
    public void convertParameters() {
        ...
        BqPolygon testSubject = new BqPolygon(expressionList);
        String resultExpressions = testSubject.getParameters().getExpressions().toString();

        Assert.assertEquals("[ST_MAKELINE(ARRAY[ST_GEOGPOINT(88.0, 188.0), ST_GEOGPOINT(288.0, 388.0), ST_GEOGPOINT(288.0, 28.0), ST_GEOGPOINT(88.0, 188.0)])]", resultExpressions);
    }
