...
public class AdqlQueryImplTest 
{
    ...
    TapSchema mockTapSchema()
    {
        ...
        foo.getColumnDescs().add(new ColumnDesc("test.foo", "f1", "adql:INTEGER", null));
        foo.getColumnDescs().add(new ColumnDesc("test.foo", "f2", "adql:CHAR", 8));
        bar.getColumnDescs().add(new ColumnDesc("test.bar", "b1", "adql:INTEGER", null));
        bar.getColumnDescs().add(new ColumnDesc("test.bar", "b2", "adql:CHAR", 8));
