...
public class TAPWebService implements WebService {
    ...
    private final static String TAPDS_TEST =
        "select schema_name from %s.schemas where schema_name='tap_schema'";
    ...
    public AvailabilityStatus getStatus() {
        ...
        try {
            ...
            final CheckDataSource checkDataSource =
                new CheckDataSource(TAPDS_NAME, String.format(TAPDS_TEST, System.getProperty("tapuser.jdbc.username")));
