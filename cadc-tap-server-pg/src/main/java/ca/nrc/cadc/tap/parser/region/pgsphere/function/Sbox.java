...
public class Sbox extends Function
{
    ...
    public Sbox(Expression lon1, Expression lon2, Expression lat1, Expression lat2)
    {
        super();
        this.lon1 = lon1;
        this.lon2 = lon2;
    ...
    private void convertParameters()
    {
        ...
        Spoint spoint2 = new Spoint(coordsys, lon2, lat2);

        // Sbox
        List<Expression> expressions = new ArrayList<Expression>();
        expressions.add(spoint1);
        expressions.add(spoint2);
