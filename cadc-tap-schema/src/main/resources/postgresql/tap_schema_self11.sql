...
( 'tap_schema.schemas', 'schema_name', 'schema name for reference to tap_schema.schemas', NULL, NULL, NULL, 'char', '64*',  NULL, 1,1,1, 1),
...
( 'tap_schema.tables', 'table_name', 'the fully qualified table name',                    NULL, NULL, NULL, 'char', '64*',  NULL, 1,1,1, 2),
...
( 'tap_schema.columns', 'table_name', 'the table this column belongs to',                 NULL, NULL, NULL, 'char', '64*',  NULL, 1,1,1, 1),
( 'tap_schema.columns', 'column_name', 'the column name',                                 NULL, NULL, NULL, 'char', '64*',  NULL, 1,1,1, 2),
...
( 'tap_schema.columns', 'datatype', 'base datatype of columns in the tableset',           NULL, NULL, NULL, 'char', '64*',  NULL, 1,0,1, 7),
( 'tap_schema.columns', 'arraysize', 'size of variable-length columns in the tableset',   NULL, NULL, NULL, 'char', '16*',  NULL, 1,0,1, 8),
( 'tap_schema.columns', 'xtype', 'a DALI or custom extended type annotation',             NULL, NULL, NULL, 'char', '64*',  NULL, 1,0,1, 9),
( 'tap_schema.columns', '"size"', 'deprecated: use arraysize',                            NULL, NULL, NULL, 'int',  NULL,   NULL, 1,0,1, 10),
( 'tap_schema.columns', 'principal', 'a principal column; 1 means true, 0 means false',   NULL, NULL, NULL, 'int',  NULL,   NULL, 1,0,1, 11),
( 'tap_schema.columns', 'indexed', 'an indexed column; 1 means true, 0 means false',      NULL, NULL, NULL, 'int',  NULL,   NULL, 1,0,1, 12),
( 'tap_schema.columns', 'std', 'a standard column; 1 means true, 0 means false',          NULL, NULL, NULL, 'int',  NULL,   NULL, 1,0,1, 13),
( 'tap_schema.columns', 'column_index', 'recommended sort order for columns of a table',  NULL, NULL, NULL, 'int',  NULL,   NULL, 1,0,1, 14),
