...
public class VarcharDatatypeTest extends AbstractDatatypeTest
{
    private static Logger log = Logger.getLogger(VarcharDatatypeTest.class);

    private static final String CLASS_NAME = "VarcharDatatypeTest";

    public VarcharDatatypeTest()
    {
        super();
        setLoggingLevel(log);
    }
    ...
    protected void validateResult(String value)
    {
        ...
        log.info("VarcharDatatypeTest.validateResult passed.");
    }
