...
public class PointDatatypeTest extends AbstractDatatypeTest
{
    private static Logger log = Logger.getLogger(IntegerDatatypeTest.class);

    private static final String CLASS_NAME = "PointDatatypeTest";

    public PointDatatypeTest()
    {
        super();
        setLoggingLevel(log);
    }
    ...
    protected void validateResult(String value)
    {
        ...
        log.info("PointDatatypeTest.validateResult passed.");
    }
