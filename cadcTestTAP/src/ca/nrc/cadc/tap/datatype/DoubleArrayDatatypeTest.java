...
public class DoubleArrayDatatypeTest extends AbstractDatatypeTest
{
    private static Logger log = Logger.getLogger(DoubleArrayDatatypeTest.class);

    private static final String CLASS_NAME = "DoubleArrayDatatypeTest";
    ...
    public DoubleArrayDatatypeTest()
    {
        super();
    }
    ...
    protected void validateResult(String value)
    {
        ...
        log.info("DoubleArrayDatatypeTest.validateResult passed.");
    }
