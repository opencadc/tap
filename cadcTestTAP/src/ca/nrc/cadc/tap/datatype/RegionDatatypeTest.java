...
public class RegionDatatypeTest extends AbstractDatatypeTest
{
    private static Logger log = Logger.getLogger(RegionDatatypeTest.class);

    private static final String CLASS_NAME = "RegionDatatypeTest";

    public RegionDatatypeTest()
    {
        super();
        setLoggingLevel(log);
    }
    ...
    protected void validateResult(String value)
    {
        ...
        log.info("RegionDatatypeTest.validateResult passed.");
    }
