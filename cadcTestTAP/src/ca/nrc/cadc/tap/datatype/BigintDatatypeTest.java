...
public class BigintDatatypeTest extends AbstractDatatypeTest
{
    private static Logger log = Logger.getLogger(BigintDatatypeTest.class);

    private static final String CLASS_NAME = "BigintDatatypeTest";

    public BigintDatatypeTest()
    {
        super();
        setLoggingLevel(log);
    }
    ...
    protected void validateResult(String value)
    {
        ...
        log.info("BigintDatatypeTest.validateResult passed.");
    }
