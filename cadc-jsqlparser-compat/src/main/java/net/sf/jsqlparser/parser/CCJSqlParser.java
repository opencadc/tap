...
{if ("" != null) return retval;}
  ...
  final public List GroupByColumnReferences() throws ParseException {ColumnReference columnReference = null;
...
{if ("" != null) return top;}
  ...
  final public ColumnReference ColumnReference() throws ParseException {ColumnReference retval = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case S_IDENTIFIER:
    case S_QUOTED_IDENTIFIER:{
      retval = Column();
...
{if ("" != null) return retval;}
  ...
  final public ColumnIndex ColumnIndex() throws ParseException {ColumnIndex retval = new ColumnIndex();
        Token index = null;
