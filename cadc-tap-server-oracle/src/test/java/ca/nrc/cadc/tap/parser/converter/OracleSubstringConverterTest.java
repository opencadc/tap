...
public class OracleSubstringConverterTest {
    @Test
    public void visit() {
        final OracleSubstringConverter testSubject =
            new OracleSubstringConverter(new ExpressionNavigator(), new ReferenceNavigator(), new FromItemNavigator());
        ...
        expectedColumnBFunction.setName("SUBSTR");
