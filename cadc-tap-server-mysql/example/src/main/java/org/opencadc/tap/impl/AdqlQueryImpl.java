...
public class AdqlQueryImpl extends AdqlQuery {
    ...
    protected void init() {
        ...
        super.navigatorList.add(new TopConverter(new ExpressionNavigator(), new ReferenceNavigator(),
        ...
        tnc.put("tap.schemas", "tap.schemas11");
        tnc.put("tap.tables", "tap.tables11");
        tnc.put("tap.columns", "tap.columns11");
        tnc.put("tap.keys", "tap.keys11");
        tnc.put("tap.key_columns", "tap.key_columns11");
